...
namespace MAVN.Service.PaymentManagement
{
    ...
    public class Startup
    {
        ...
        {
            ApiTitle = "PaymentManagement API",
            ApiVersion = "v1"
        };
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            (_configurationRoot, _settingsManager) = services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PaymentManagementLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PaymentManagementService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PaymentManagement", channelOptions =>
                        {
